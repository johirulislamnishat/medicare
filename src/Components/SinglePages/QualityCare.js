                        ...
                        <div className="flex flex-col justify-center">
                            <div>
                                ...
                                <div className="flex flex-wrap justify-center md:justify-start gap-6 md:gap-10">
                                    ...
                                    <button className='border-none rounded-md py-3 px-5 bg-indigo-500 text-white text-base'>Contact Us</button>

                                    <button className='border-none rounded-md py-3 px-6 bg-indigo-500 text-white text-base'>About Us</button>
